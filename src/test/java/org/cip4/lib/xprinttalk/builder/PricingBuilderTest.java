...
/**
 * JUnit test case for PricingBuilder
 * @author s.meissner
 * @date 14.01.2013
 */
public class PricingBuilderTest extends AbstractBuilderTest<PrintTalk> {
	...
	/**
	 * Test method for {@link org.cip4.lib.xprinttalk.builder.PricingBuilder#appendPrice(java.lang.String, double, org.cip4.lib.xjdf.schema.XJDF)}.
	 * @throws Exception
	 */
	@Test
	public void testPricingIntegration() throws Exception {
		...
		String actualIdValueLineID = getXPathValue(bytes, "/ptk:PrintTalk/ptk:Request/ptk:PurchaseOrder/xjdf:XJDF/xjdf:GeneralID[@IDUsage='Line_ID']/@IDValue");
		Assert.assertEquals("LineID is wrong.", "Line_1", actualIdValueLineID);

		String actualDescName = getXPathValue(bytes, "/ptk:PrintTalk/ptk:Request/ptk:PurchaseOrder/ptk:Pricing/ptk:Price[@LineID='Line_1']/@DescriptiveName");
