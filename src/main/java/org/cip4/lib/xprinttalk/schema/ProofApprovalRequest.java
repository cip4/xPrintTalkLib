    ...
    implements Serializable
{
    ...
    protected List<ProofRequest> proofRequest;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the proofRequest property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<ProofRequest> getProofRequest() {
        if (proofRequest == null) {
            proofRequest = new ArrayList<ProofRequest>();
        }
